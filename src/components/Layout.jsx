...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      ...
      >
        Big Sister is Bri&apos;s brain child she has been trying to develop for years. Through the support of Patreon, she is excited to create her own series of zines centered around sibling relationships and other aspects of the family system. Along with Big Sister, zine topics will include depression, anxiety, vulnerability, faith, and more. 
      </p>
      {!isExpanded && (
        <button
          type="button"
